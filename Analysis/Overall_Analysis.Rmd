  ...
  aes(x = date, y = unclass.san.pump)) +
    ...
    annotate(
      ...
      x = c(
        ...
        as.Date("2003-01-01"),
        as.Date("2018-12-01")), 
      y = c(70, 70, 70, 70, 70, 70), colour = "#BB2D05", size = 3) +
...
(ras.pump = ggplot(df.ras.pump,
    ...
    annotate(
      ...
      x = c(
        ...
        as.Date("2003-01-01"),
        as.Date("2018-12-01")), 
      y = c(50, 50, 50, 50, 50, 50), colour = "#BB2D05", size = 3) +
    annotate(geom = "text", x = c(
        as.Date("1977-01-01"),
        as.Date("1988-01-01"),
        as.Date("1998-01-01"),
  ...
  labs(caption = "Data Source: Land Reclamation Consortium Ravenna",
    ...
    annotate(
      ...
      x = c(
        ...
        as.Date("2003-01-01"),
        as.Date("2018-12-01")), 
      y = c(40, 40, 40, 40, 40, 40), colour = "#BB2D05", size = 3) +
    annotate(geom = "text", x = c(
        as.Date("1977-01-01"),
        as.Date("1988-01-01"),
        as.Date("1998-01-01"),
        as.Date("2010-01-01")), y = c(44, 44, 44, 44), 
        label = c("severe subsidence, coastal extremes [..]", "prolonged dryness", "rainfall rises", "starts to increase"), 
        hjust = c("middle", "middle", "middle", "middle"))
  )
...
(san.ann.pump = ggplot(data = san.ann.data,
   ...
   labs(x = "year", 
       y = "pu (mm)", 
       title = "Annual San Vitale Pumping") +
   theme(
      axis.ticks.y = element_line(),
      axis.text.y = element_text(),
      axis.title.y = element_text(),
...
(p1 <- ggplot(df) + 
  ...
  annotate(geom = "segment",
           ...
           yend = 200,
           arrow = arrow(type = "closed",
                         length = unit(0.130, "inches"))) +
  geom_label(aes(x = 1987, y = 200, 
